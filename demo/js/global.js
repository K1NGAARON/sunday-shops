...
const oneSizeProductsURL = [
    'https://demo.shop.teamsunday.com/product/box-multiple-items/',
    'https://demo.shop.teamsunday.com/product/sizeless-item/'
];
...
function addPriceIcon(e) {
    ...
    if (!priceTargets) {
        ...
        priceTargets.forEach(priceTarget => {
            ...
            const textNode = document.createTextNode('Sunday-coins');
